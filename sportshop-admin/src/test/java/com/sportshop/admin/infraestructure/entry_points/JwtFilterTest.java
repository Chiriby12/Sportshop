...
@DisplayName("JwtFilter (admin) - Tests del filtro JWT")
class JwtFilterTest {
    ...
    @Test
    @DisplayName("token malformado: no lanza excepción")
    void tokenMalformado() throws Exception {
        when(request.getHeader("Authorization")).thenReturn("Bearer solounstring");
